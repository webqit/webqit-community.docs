...
This function wraps an object or array in a proxy with all operations on the instance forwarded to the appropriate [*interceptors*](../api/interceptors.md), and announced to [*observers*](../api/observe.md).
